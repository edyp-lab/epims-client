...
package fr.edyp.epims.ui.panels.robot.gesture;
...
/**
 *
 * Used to perform a square selection
 *
 * @author JM235353
 *
 */
public class SelectionGestureSquare extends AbstractSelectionGesture {
    ...
    public static final Color COLOR_BLUE_SELECTION_ZONE = new Color(0.2f, 0.2f, 1f, 0.5f);

    private static final float DASH1[] = {10.0f};
    private static final BasicStroke DASHED_STROKE = new BasicStroke(2.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, DASH1, 0.0f);
    ...
    public void paint(Graphics g) {
        ...
        g2.setColor(COLOR_BLUE_SELECTION_ZONE);
