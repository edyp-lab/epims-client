...
/**
 *
 * This class contains informations about a Task (description, timestamps and status)
 *
 * @author JM235353
 *
 */
public class TaskInfo implements Comparable<TaskInfo> {
    ...
    private TaskInfoCallbackInterface m_callback = null;

    public TaskInfo(TaskInfoCallbackInterface callback, String taskDescription, boolean askBeforeExitingApp, String idList) {
    ...
    public void setRunning(boolean saveTimestamp) {
        ...
        if (m_callback != null) m_callback.stateChaned(m_updateState);
