...
/**
 *
 * Modify an existing Actor (Laboratory User)
 *
 * @author JM235353
 *
 */
public class ModifyActorTask extends AbstractAuthenticateDatabaseTask {
    ...
    public ModifyActorTask(AbstractDatabaseCallback callback, ActorJson[] actor) {
        super(callback, new TaskInfo("Modify Actor "+actor[0].getLogin(), false, null), TokenManager.TOKEN_EPIMS_SERVER);

        URL = DataManager.getServerURL()+"/api/modifyactor";
