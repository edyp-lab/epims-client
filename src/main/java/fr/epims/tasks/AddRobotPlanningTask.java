...
/**
 *
 * Used to ask for a sample to be placed on a Robot Plate
 *
 * @author JM235353
 *
 */
public class AddRobotPlanningTask extends AbstractAuthenticateDatabaseTask {
    ...
    public AddRobotPlanningTask(AbstractDatabaseCallback callback, ArrayList<RobotPlanningJson> robotPlanningJsonArrayList) {
        super(callback, new TaskInfo("Ask for Sample Robot Planning ", false, null), TokenManager.TOKEN_EPIMS_SERVER);

        URL = DataManager.getServerURL()+"/api/addrobotplanning";
