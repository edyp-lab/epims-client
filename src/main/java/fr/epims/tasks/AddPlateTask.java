 ...
 *
 */
public class AddPlateTask extends AbstractAuthenticateDatabaseTask {
    ...
    public AddPlateTask(AbstractDatabaseCallback callback, VirtualPlateJson virtualPlate) {
        super(callback, new TaskInfo("Add Robot Plate "+virtualPlate.getName(), false, null), TokenManager.TOKEN_EPIMS_SERVER);

        URL = DataManager.getServerURL()+"/api/addplate";
