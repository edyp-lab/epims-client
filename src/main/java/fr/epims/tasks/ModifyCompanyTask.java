...
/**
 *
 * Modify a company (affiliation of a Contact)
 *
 * @author JM235353
 *
 */
public class ModifyCompanyTask  extends AbstractAuthenticateDatabaseTask {


    private String URL;

    private CompanyJson[] m_companyJson;


    public ModifyCompanyTask(AbstractDatabaseCallback callback, CompanyJson[] company) {
        super(callback, new TaskInfo("Modify Affiliation "+company[0].getName(), false, null), TokenManager.TOKEN_EPIMS_SERVER);

        URL = DataManager.getServerURL()+"/api/modifycompany";
